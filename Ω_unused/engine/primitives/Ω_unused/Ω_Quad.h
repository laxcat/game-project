// #pragma once
// #include "../shader/shaders/gltf/VertStandard.h"
...
//     inline VertStandard * vbufferForIndex(Renderable * r, size_t index) {
//         return (VertStandard *)(r->buffer + buffersSize(index));
//     }
